...
local frame = Instance.new("Frame", pagAceitar)
frame.Size = UDim2.new(0,300,0,150)
frame.Position = UDim2.new(0,220,0,20)
frame.BackgroundColor3 = Color3.fromRGB(20,20,20)
frame.BorderSizePixel = 0
frame.Active = true
frame.Draggable = true
...
local strokeSkin = Instance.new("UIStroke", frame)
strokeSkin.Color = Color3.fromRGB(0,170,255)
strokeSkin.Thickness = 2
...
creditsTitle.Text = "DAVIZINSCRIPTS PRO MAX V6     X"
...
botaoLogin.MouseButton1Click:Connect(function()
	if senhaBox.Text == "FREE_QL102O5MVADMINHUBQOR24H" then
		loginGui:Destroy()
		gui.Enabled = true

		local args1 = { "RolePlayName", "Davi hub" }
		Rep.RE["1RPNam1eTex1t"]:FireServer(unpack(args1))
		local args2 = { "RolePlayBio", "By: davizinscripts" }
...
discordGui.Parent = Player.PlayerGui
discordGui.ResetOnSpawn = false

local frameDiscord = Instance.new("Frame", discordGui)
frameDiscord.Size = UDim2.new(0, 320, 0, 160)
frameDiscord.Position = UDim2.new(0.5, 0, 0.5, 0)
frameDiscord.AnchorPoint = Vector2.new(0.5, 0.5)
frameDiscord.BackgroundColor3 = Color3.fromRGB(20,20,25)
frameDiscord.BorderSizePixel = 0
frameDiscord.Active = true
frameDiscord.Draggable = true

Instance.new("UICorner", frameDiscord).CornerRadius = UDim.new(0,20)

local strokeDiscord = Instance.new("UIStroke", frameDiscord)
strokeDiscord.Color = Color3.fromRGB(0,170,255)
strokeDiscord.Thickness = 2

-- TEXTO
local discordText = Instance.new("TextLabel", frameDiscord)
discordText.Size = UDim2.new(1,0,0,70)
discordText.Position = UDim2.new(0,0,0,20)
discordText.BackgroundTransparency = 1
discordText.Text = "DISCORD AQUI!"
discordText.Font = Enum.Font.GothamBlack
discordText.TextScaled = true
discordText.TextColor3 = Color3.fromRGB(0,170,255)

-- BOTÃO COPIAR
local btnCopy = Instance.new("TextButton", frameDiscord)
btnCopy.Size = UDim2.new(0.8,0,0,45)
btnCopy.Position = UDim2.new(0.1,0,0,95)
btnCopy.BackgroundColor3 = Color3.fromRGB(0,170,255)
...
local discordLink = "https://discord.gg/TDkCjVhht"
